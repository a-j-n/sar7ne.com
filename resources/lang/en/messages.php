...
return [
    ...
    'posts' => [
        ...
        'new_drops' => 'new drops',
        'stay_kind' => 'Stay kind',
        'keep_it_thoughtful' => 'Keep it thoughtful',
        'quick_tip' => 'Quick tip',
        'pin_best_post' => 'Pin your best post',
        'tip_body' => 'Dropping multiple images? Keep captions short—long text is wrapped and clamped in the feed so your message stays readable on mobile.',
        'jump_to_feed' => 'Jump to feed',
        'drag_drop_upload' => 'Drag and drop or click to upload',
        'upload_hint' => 'JPG, PNG, or WEBP up to 6MB each. Max 4 images.',
        'choose_files' => 'Choose files',
        'share_a_post' => 'Share a post',
        'share_intro' => 'Drop a message or photo set. Long text wraps automatically, and images stay tidy on every screen.',
    ],
    'posts_title' => 'Posts',
    // Homepage / Explore
    ...
    'spotlight' => 'Spotlight',
    'people_receiving_drops' => 'People receiving new drops',
    'live_now' => 'Live',
    'stay_tuned_profiles' => 'Stay tuned — new profiles drop soon.',
    'anonymous_by_default' => 'Anonymous by default',
    'shareable_profile_link' => 'Shareable profile link',
